...
if(isset($_COOKIE[$cookie_name])){
  ...
  $query = mysqli_query($con, "select * from token_details where token = '$cookie_token'");
  $data = mysqli_fetch_array($query);
  $email = $data['email'];

  $q = mysqli_query($con, "select * from token_details where email='$email' and token = '$cookie_token'");
  $rows = mysqli_num_rows($q);
  if ($rows == 1) {
    $_SESSION['email'] = $email;
    $_SESSION['token'] = $cookie_token;
              ...
              <form role="form">
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Name" name="name_input" id="name_input" type="text">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Email" name="email_input" id="email_input" type="email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Password" name="pass_input" id="pass_input" type="password">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Confirm Password" name="pass_input_confirm" id="pass_input_confirm" type="text">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-primary mt-4" onclick="signup_form();">Create account</button>
                </div>
                <span id="data"></span>
              </form>
            </div>
